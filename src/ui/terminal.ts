...
const BASE_COMMANDS = [
  ...
  'mlflow runs tag stage=candidate',
  'mlflow runs source --git abc1234 --entry train.py',
  ...
  'mlflow models register -n churn --flavor sklearn',
  'mlflow models list',
  'mlflow models get iris-clf',
  'mlflow models describe -n iris-clf --version 1 --text',
